...
// Root endpoint - Project Landing Page
app.get('/', (req, res) => {
  res.send(`
<!DOCTYPE html>
<html lang="vi">
<head>
  ...
  <title>Thiết Bị Đọc Chuyển Khoản - ESP32 Payment System</title>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .api-endpoint .method.post { background: #fbbf24; }
    .tech-stack {
      display: flex;
      flex-wrap: wrap;
      gap: 15px;
...
<body>
  <div class="container">
    <header>
      ...
      <p class="subtitle">Hệ Thống Thông Báo Thanh Toán Thông Minh</p>
      <div>
        <span class="badge"><span class="status-indicator"></span>API Running</span>
        <span class="badge">v1.0.0</span>
        <span class="badge">ESP32 + Node.js</span>
      </div>
    </header>

    <div class="section">
      <h2>📋 Thông Tin Dự Án</h2>
      <p><strong>Lĩnh vực:</strong> Tài chính thông minh (FinTech IoT)</p>
      <p><strong>Tên đề tài:</strong> Thiết bị đọc chuyển khoản tự động</p>
      <p><strong>Mô tả:</strong> Hệ thống IoT kết hợp ESP32 và Backend API để tự động nhận thông báo thanh toán từ ngân hàng, hiển thị thông tin giao dịch trên màn hình OLED, phát âm thanh tiếng Việt và quản lý doanh thu qua Dashboard web.</p>
    </div>
    ...
    <div class="section">
      ...
      <div class="flow-diagram">
        <div class="flow-step">
          ...
          <div>
            <strong>Input:</strong> Khách hàng chuyển khoản qua QR Code hoặc số tài khoản → SePay nhận biến động số dư
          </div>
        </div>
        <div class="flow-step">
          <div class="number">2</div>
          <div>
            <strong>Process:</strong> SePay gửi Webhook → Backend API xử lý và gửi thông báo qua MQTT
          </div>
        </div>
        <div class="flow-step">
          <div class="number">3</div>
          <div>
            <strong>Output:</strong> ESP32 nhận MQTT → Hiển thị số tiền trên màn hình OLED + Phát âm thanh tiếng Việt
          </div>
        </div>
        <div class="flow-step">
          <div class="number">4</div>
          <div>
            <strong>Dashboard:</strong> Cập nhật doanh thu real-time, theo dõi trạng thái thiết bị (Online/Offline)
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="section">
      ...
      <div class="feature-grid">
        <div class="feature-card">
          <h3>🖥️ Thiết Bị ESP32</h3>
          <p>• Màn hình OLED hiển thị mã QR và số tiền<br>
          • Loa DFPlayer phát âm thanh tiếng Việt<br>
          • LED báo hiệu trạng thái kết nối<br>
          • Tự động kết nối WiFi & MQTT</p>
        </div>
        <div class="feature-card">
          <h3>🌐 Backend API</h3>
          <p>• Nhận Webhook từ SePay<br>
          • Gửi thông báo qua MQTT<br>
          • Quản lý giao dịch & đơn hàng<br>
          • Fallback database (JSON) khi offline</p>
        </div>
        <div class="feature-card">
          <h3>📊 Web Dashboard</h3>
          <p>• Theo dõi doanh thu theo ngày/tháng<br>
          • Trạng thái thiết bị real-time<br>
          • Tạo mã QR thanh toán nhanh<br>
          • Quản lý đơn hàng POS</p>
        </div>
      </div>
    </div>
    ...
    <div class="section">
      ...
      <div class="api-endpoint">
        ...
        <strong>/api/v1/dashboard</strong> - Lấy thông tin tổng quan (doanh thu, thiết bị)
      </div>
      <div class="api-endpoint">
        <span class="method post">POST</span>
        <strong>/sepay-webhook</strong> - Nhận thông báo giao dịch từ SePay
      </div>
      <div class="api-endpoint">
        <span class="method post">POST</span>
        <strong>/api/v1/orders</strong> - Tạo đơn hàng mới (POS)
      </div>
      <div class="api-endpoint">
        <span class="method">GET</span>
        <strong>/api/v1/orders</strong> - Lấy danh sách đơn hàng
      </div>
      <div class="api-endpoint">
        <span class="method">GET</span>
        <strong>/api/v1/orders/stats/summary</strong> - Thống kê doanh thu
      </div>
      <div class="api-endpoint">
        <span class="method">GET</span>
        <strong>/api/v1/devices/:device_id</strong> - Trạng thái thiết bị
      </div>
    </div>
    ...
    <div class="section">
      ...
      <div class="tech-stack">
        <div class="tech-badge">ESP32 (C++)</div>
        <div class="tech-badge">Node.js + Express</div>
        <div class="tech-badge">React (Vite)</div>
        <div class="tech-badge">MQTT Protocol</div>
        <div class="tech-badge">PostgreSQL</div>
        <div class="tech-badge">Redis</div>
        <div class="tech-badge">WebSocket</div>
        <div class="tech-badge">SePay API</div>
        <div class="tech-badge">OLED SSD1306</div>
        <div class="tech-badge">DFPlayer Mini</div>
      </div>
    </div>
    ...
    <div class="section">
      ...
      <div class="feature-grid">
        <div class="feature-card">
          <h3>☕ Quán Cà Phê</h3>
          <p>Tự động thông báo khi khách thanh toán, giảm thời gian chờ đợi</p>
        </div>
        <div class="feature-card">
          <h3>🍜 Nhà Hàng</h3>
          <p>Quản lý nhiều quầy thu ngân, theo dõi doanh thu real-time</p>
        </div>
        <div class="feature-card">
          <h3>🛒 Cửa Hàng Tạp Hóa</h3>
          <p>Xác nhận thanh toán nhanh chóng, giảm sai sót</p>
        </div>
      </div>
    </div>

    <footer>
      <p>🚀 Developed with ❤️ by Escanor292</p>
      <p>📧 GitHub: <a href="https://github.com/Escanor292/esp32" style="color: #ffd700;">github.com/Escanor292/esp32</a></p>
    </footer>
  </div>
</body>
</html>
